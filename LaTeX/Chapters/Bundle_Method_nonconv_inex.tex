...
where \(\partial f(x)\) is the Clarke subdifferential \textcolor{red}{defined in Preliminaries section} of \(f\).
...
\(\partial_{[\varepsilon]}f(x)\) is also known as the \emph{Fréchet \(\varepsilon\)-subdifferential} of \(f(x)\)
