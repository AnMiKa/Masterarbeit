...
It is remarked in \cite[p. 96]{Outrata1998}, that if the LICQ does not hold for a minimum \((w^{\top},b,\xi^{\top})\), then the GE coming from this problem is not strongly regular in this point.
