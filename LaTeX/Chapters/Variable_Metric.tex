...
\textcolor{red}{\subsubsection{Adaptive Scaling of Single Eigenvalues}}

\textcolor{red}{This second method is motivated by the following observation: The variable metric bundle algorithm is to be used for nonsmooth functions. This means that the objective function has some kinks. 
