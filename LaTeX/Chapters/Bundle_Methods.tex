...
It can however impair the speed of convergence if the bundle is kept too small and provides hence less information about the objective function \cite{Oliveira2014a}.
