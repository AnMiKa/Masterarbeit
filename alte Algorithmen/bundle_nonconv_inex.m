function [ f_hat, x_hat, x, i_null  ] = ...
    bundle_nonconv_inex( x0, fun, subgr_fun, subprob_flag, lm_flag, J_flag)
...
%%    
    ...
    if J_flag
        alpha = lambda.ineqlin(1:lJ); % müssten da nicht eigentlich auch die
                                      % Multiplikatoren für die D-constraints dazu?
                                      % wie passt das dann mit den c's
                                      % zusammen? sind ja dnn mehr als J?
