function [ f_hat, x_hat, delta, time ] = bundle_bilevel_reg( x0, X, Y, kmax, m, t, tol, gamma)
...
Dw = subgr_ll_reg_moore(W,X,Y,x_hat);
...
[d,~,alpha] = solve_ul_reg_qp(x_hat,s,c,t);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% set subgradient function for lower level problem
Dw = subgr_ll_reg_moore(W,X,Y,x_hat+d);
% set subgradient function for upper level problem
g(:,end+1) = subgr_ul_reg_moore(W,X,Y,Dw);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
