...
%         bundle_bilevel_outr(C(c),Xtcan,Ytcan,2000,1e-6);
%     [fvalH(2,c),CminH(2,c),stepsH(2,c),nullstepsH(2,c),timeH(2,c),eta_maxH(2,c)] =...
%         bundle_bilevel_outr(C(c),Xtion,Ytion,2000,1e-6);
%     [fvalH(3,c),CminH(3,c),stepsH(3,c),nullstepsH(3,c),timeH(3,c),eta_maxH(3,c)] =...
%         bundle_bilevel_outr(C(c),Xtbox,Ytbox,2000,1e-6);
%     [fvalH(4,c),CminH(4,c),stepsH(4,c),nullstepsH(4,c),timeH(4,c),eta_maxH(4,c)] =...
%         bundle_bilevel_outr(C(c),Xtsys,Ytsys,2000,1e-6);
    [fvalH(5,c),CminH(5,c),stepsH(5,c),nullstepsH(5,c),timeH(5,c),eta_maxH(5,c)] =...
        bundle_bilevel_outr(C(c),Xtsyb,Ytsyb,1000,1e-6);
end
...
%         bundle_bilevel_outr_noll(C(c),Xtcan,Ytcan,1,1000,1e-6);
%     [fvalN(2,c),CminN(2,c),stepsN(2,c),nullstepsN(2,c),timeN(2,c),eta_maxN(2,c)] =...
%         bundle_bilevel_outr_noll(C(c),Xtion,Ytion,1,1000,1e-6);
%     [fvalN(3,c),CminN(3,c),stepsN(3,c),nullstepsN(3,c),timeN(3,c),eta_maxN(3,c)] =...
%         bundle_bilevel_outr_noll(C(c),Xtbox,Ytbox,1,1000,1e-6);
%     [fvalN(4,c),CminN(4,c),stepsN(4,c),nullstepsN(4,c),timeN(4,c),eta_maxN(4,c)] =...
%         bundle_bilevel_outr_noll(C(c),Xtsys,Ytsys,1,1000,1e-6);
    [fvalN(5,c),CminN(5,c),stepsN(5,c),nullstepsN(5,c),timeN(5,c),eta_maxN(5,c)] =...
        bundle_bilevel_outr_noll(C(c),Xtsyb,Ytsyb,1,1000,1e-6);
end
