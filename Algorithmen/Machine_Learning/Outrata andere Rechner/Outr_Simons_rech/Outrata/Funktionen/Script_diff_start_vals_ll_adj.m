...
%     bundle_bilevel_outr_noll(C,Xtcan,Ytcan,1,1000,1e-10);
% [fvalN(2),CminN(2),stepsN(2),nullstepsN(2),timeN(2),eta_maxN(2)] =...
%     bundle_bilevel_outr_noll(C,Xtion,Ytion,1,1000,1e-10);
[fvalN(3),CminN(3),stepsN(3),nullstepsN(3),timeN(3),eta_maxN(3)] =...
    bundle_bilevel_outr_noll(C,Xtbox,Ytbox,1,1000,1e-10);
% [fvalN(4),CminN(4),stepsN(4),nullstepsN(4),timeN(4),eta_maxN(4)] =...
%     bundle_bilevel_outr_noll(C,Xtsys,Ytsys,1,1000,1e-10);
% [fvalN(5),CminN(5),stepsN(5),nullstepsN(5),timeN(5),eta_maxN(5)] =...
%     bundle_bilevel_outr_noll(C,Xtsyb,Ytsyb,1,1000,1e-10);
% 
