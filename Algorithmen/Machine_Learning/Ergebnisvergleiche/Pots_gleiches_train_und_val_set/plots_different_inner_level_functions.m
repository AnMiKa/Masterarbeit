...
for l = 1:length(lambda)
    Wbhq(:,l) = postpro_wb_class_hingequad_qp(Xvcancer1,Yvcancer1,lambda(l));
end
W = Wbhq(1:9,:);
b = Wbhq(10,:);
...
for l = 1:length(lambda)
    errhm(l) = postpro_err_misclass(W(:,l),b(l),Xvcancer1,Yvcancer1);
    errhh(l) = postpro_err_hinge(W(:,l),b(l),Xvcancer1,Yvcancer1);
    errhhq(l) = postpro_err_hingequad(W(:,l),b(l),Xvcancer1,Yvcancer1);
    errhqm(l) = postpro_err_misclass(W(:,l),b(l),Xvcancer1,Yvcancer1);
    errhqh(l) = postpro_err_hinge(W(:,l),b(l),Xvcancer1,Yvcancer1);
    errhqhq(l) = postpro_err_hingequad(W(:,l),b(l),Xvcancer1,Yvcancer1);
end
