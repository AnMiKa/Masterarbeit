...
[X,Y] = precond_data('Data/Kunapuli/pima_standard_pm1.mat',1,1:297,1);
[feat, n] = size(X);
lambda = 20*rand(1)-10;

%% Test 1a: df/dlambda for hingequad loss for w, b
eps = 1e-10;
...
%% Test 1b: df/dlambda for hinge loss for w, b
eps = 1e-10;
...
%% Test 3a: dwb/dlambda for hingequad loss for w, b
eps = 1e-8;
Wb1 = solve_ll_class_hingequad_qpas(X,Y,lambda+eps);
Wb2 = solve_ll_class_hingequad_qpas(X,Y,lambda-eps);
Wb = solve_ll_class_hingequad_qpas(X,Y,lambda);
