...
for d = 1:15
    for f = 1:5
        ...
        stem((3*f-2)+(d-1)*.15,log_kQf_nb30_s(d,f), 'p:c','filled')
        stem((3*f-2)+(d-1)*.15,log_kQf_ns30_s(d,f), 'x:m','filled')
    end
end
% Add a legend
...
for d = 1:3
    for f = 1:5
        ...
        stem((f)+(d-1)*.15,log_kQf_nb30_b(d,f), 'p:c','filled')
        stem((f)+(d-1)*.15,log_kQf_ns30_b(d,f), 'x:m','filled')
    end
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
...
for d = 1:15
    for f = 1:5
        ...
        stem((3*f-2)+(d-1)*.15,log_kQf_nb60_s(d,f), 'p:c','filled')
        stem((3*f-2)+(d-1)*.15,log_kQf_ns60_s(d,f), 'x:m','filled')
    end
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
...
for d = 1:3
    for f = 1:5
        ...
        stem((f)+(d-1)*.15,log_kQf_nb60_b(d,f), 'p:c','filled')
        stem((f)+(d-1)*.15,log_kQf_ns60_b(d,f), 'x:m','filled')
    end
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
...
for d = 1:15
    for f = 1:5
        ...
        stem((3*f-2)+(d-1)*.15,log_kQf_nb31_s(d,f), 'p:c','filled')
        stem((3*f-2)+(d-1)*.15,log_kQf_ns31_s(d,f), 'x:m','filled')
    end
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
...
for d = 1:3
    for f = 1:5
        ...
        stem((f)+(d-1)*.15,log_kQf_nb31_b(d,f), 'p:c','filled')
        stem((f)+(d-1)*.15,log_kQf_ns31_b(d,f), 'x:m','filled')
    end
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
...
for d = 1:15
    for f = 1:5
        ...
        stem((3*f-2)+(d-1)*.15,log_kQf_nb61_s(d,f), 'p:c','filled')
        stem((3*f-2)+(d-1)*.15,log_kQf_ns61_s(d,f), 'x:m','filled')
    end
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
...
for d = 1:3
    for f = 1:5
        ...
        stem((f)+(d-1)*.15,log_kQf_nb61_b(d,f), 'p:c','filled')
        stem((f)+(d-1)*.15,log_kQf_ns61_b(d,f), 'x:m','filled')
    end
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
...
%     stem(x+(d-1)*.15,log_kQf_nb32_s(:,d), 'p:c','filled')
%     stem(x+(d-1)*.15,log_kQf_ns32_s(:,d), 'x:m','filled')
% end
% % Add a legend
% legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
%     'Varible Metric SR1')
...
%     stem(x+(d-1)*.15,log_kQf_nb32_b(:,d), 'p:c','filled')
%     stem(x+(d-1)*.15,log_kQf_ns32_b(:,d), 'x:m','filled')
% end
% % Add a legend
% legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
%     'Varible Metric SR1')
...
%     stem(x+(d-1)*.15,log_kQf_nb62_s(:,d), 'p:c','filled')
%     stem(x+(d-1)*.15,log_kQf_ns62_s(:,d), 'x:m','filled')
% end
% % Add a legend
% legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
%     'Varible Metric SR1')
...
%     stem(x+(d-1)*.15,log_kQf_nb62_b(:,d), 'p:c','filled')
%     stem(x+(d-1)*.15,log_kQf_ns62_b(:,d), 'x:m','filled')
% end
% % Add a legend
% legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
%     'Varible Metric SR1')
...
%     stem(x+(d-1)*.15,log_kQf_nb33_s(:,d), 'p:c','filled')
%     stem(x+(d-1)*.15,log_kQf_ns33_s(:,d), 'x:m','filled')
% end
% % Add a legend
% legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
%     'Varible Metric SR1')
...
%     stem(x+(d-1)*.15,log_kQf_nb33_b(:,d), 'p:c','filled')
%     stem(x+(d-1)*.15,log_kQf_ns33_b(:,d), 'x:m','filled')
% end
% % Add a legend
% legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
%     'Varible Metric SR1')
...
%     stem(x+(d-1)*.15,log_kQf_nb63_s(:,d), 'p:c','filled')
%     stem(x+(d-1)*.15,log_kQf_ns63_s(:,d), 'x:m','filled')
% end
% % Add a legend
% legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
%     'Varible Metric SR1')
...
%     stem(x+(d-1)*.15,log_kQf_nb63_b(:,d), 'p:c','filled')
%     stem(x+(d-1)*.15,log_kQf_ns63_b(:,d), 'x:m','filled')
% end
% % Add a legend
% legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
%     'Varible Metric SR1')
...
%     stem(x+(d-1)*.15,log_kQf_nb34_s(:,d), 'p:c','filled')
%     stem(x+(d-1)*.15,log_kQf_ns34_s(:,d), 'x:m','filled')
% end
% % Add a legend
% legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
%     'Varible Metric SR1')
...
%     stem(x+(d-1)*.15,log_kQf_nb34_b(:,d), 'p:c','filled')
%     stem(x+(d-1)*.15,log_kQf_ns34_b(:,d), 'x:m','filled')
% end
% % Add a legend
% legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
%     'Varible Metric SR1')
...
%     stem(x+(d-1)*.15,log_kQf_nb64_s(:,d), 'p:c','filled')
%     stem(x+(d-1)*.15,log_kQf_ns64_s(:,d), 'x:m','filled')
% end
% % Add a legend
% legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
%     'Varible Metric SR1')
...
%     stem(x+(d-1)*.15,log_kQf_nb64_b(:,d), 'p:c','filled')
%     stem(x+(d-1)*.15,log_kQf_ns64_b(:,d), 'x:m','filled')
% end
% % Add a legend
% legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
%     'Varible Metric SR1')
