...
for i = 1:5
    ...
    stem(x+(i-1)*.15,t_kQ_nb30_s(:,i), 'p:c','filled')
    stem(x+(i-1)*.15,t_kQ_ns30_s(:,i), 'x:m','filled')
end
% Add a legend
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,t_kQ_nb30_b(:,i), 'p:c','filled')
    stem(x+(i-1)*.15,t_kQ_ns30_b(:,i), 'x:m','filled')
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
    'Varible Metric SR1')
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,t_kQ_nb60_s(:,i), 'p:c','filled')
    stem(x+(i-1)*.15,t_kQ_ns60_s(:,i), 'x:m','filled')
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
    'Varible Metric SR1')
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,t_kQ_nb60_b(:,i), 'p:c','filled')
    stem(x+(i-1)*.15,t_kQ_ns60_b(:,i), 'x:m','filled')
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
    'Varible Metric SR1')
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,t_kQ_nb31_s(:,i), 'p:c','filled')
    stem(x+(i-1)*.15,t_kQ_ns31_s(:,i), 'x:m','filled')
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
    'Varible Metric SR1')
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,t_kQ_nb31_b(:,i), 'p:c','filled')
    stem(x+(i-1)*.15,t_kQ_ns31_b(:,i), 'x:m','filled')
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
    'Varible Metric SR1')
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,t_kQ_nb61_s(:,i), 'p:c','filled')
    stem(x+(i-1)*.15,t_kQ_ns61_s(:,i), 'x:m','filled')
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
    'Varible Metric SR1')
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,t_kQ_nb61_b(:,i), 'p:c','filled')
    stem(x+(i-1)*.15,t_kQ_ns61_b(:,i), 'x:m','filled')
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
    'Varible Metric SR1')
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,t_kQ_nb32_s(:,i), 'p:c','filled')
    stem(x+(i-1)*.15,t_kQ_ns32_s(:,i), 'x:m','filled')
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
    'Varible Metric SR1')
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,t_kQ_nb32_b(:,i), 'p:c','filled')
    stem(x+(i-1)*.15,t_kQ_ns32_b(:,i), 'x:m','filled')
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
    'Varible Metric SR1')
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,t_kQ_nb62_s(:,i), 'p:c','filled')
    stem(x+(i-1)*.15,t_kQ_ns62_s(:,i), 'x:m','filled')
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
    'Varible Metric SR1')
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,t_kQ_nb62_b(:,i), 'p:c','filled')
    stem(x+(i-1)*.15,t_kQ_ns62_b(:,i), 'x:m','filled')
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
    'Varible Metric SR1')
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,t_kQ_nb33_s(:,i), 'p:c','filled')
    stem(x+(i-1)*.15,t_kQ_ns33_s(:,i), 'x:m','filled')
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
    'Varible Metric SR1')
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,t_kQ_nb33_b(:,i), 'p:c','filled')
    stem(x+(i-1)*.15,t_kQ_ns33_b(:,i), 'x:m','filled')
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
    'Varible Metric SR1')
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,t_kQ_nb63_s(:,i), 'p:c','filled')
    stem(x+(i-1)*.15,t_kQ_ns63_s(:,i), 'x:m','filled')
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
    'Varible Metric SR1')
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,t_kQ_nb63_b(:,i), 'p:c','filled')
    stem(x+(i-1)*.15,t_kQ_ns63_b(:,i), 'x:m','filled')
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
    'Varible Metric SR1')
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,t_kQ_nb34_s(:,i), 'p:c','filled')
    stem(x+(i-1)*.15,t_kQ_ns34_s(:,i), 'x:m','filled')
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
    'Varible Metric SR1')
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,t_kQ_nb34_b(:,i), 'p:c','filled')
    stem(x+(i-1)*.15,t_kQ_ns34_b(:,i), 'x:m','filled')
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
    'Varible Metric SR1')
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,t_kQ_nb64_s(:,i), 'p:c','filled')
    stem(x+(i-1)*.15,t_kQ_ns64_s(:,i), 'x:m','filled')
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
    'Varible Metric SR1')
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,t_kQ_nb64_b(:,i), 'p:c','filled')
    stem(x+(i-1)*.15,t_kQ_ns64_b(:,i), 'x:m','filled')
end
% Add a legend
legend('Nonconv Iinex Bundle', 'Variable Metric BFGS', ...
    'Varible Metric SR1')
