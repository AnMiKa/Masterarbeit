...
% constant noise
log_f_h1 = abs(log10(sum(f_h(:,2,:,:),4)/10));
k_h1 = ceil(sum(k_h(:,2,:,:),4)/10);

% vanishing noise
log_f_h2 = abs(log10(sum(f_h(:,3,:,:),4)/10));
k_h2 = ceil(sum(k_h(:,3,:,:),4)/10);

% constant gradient noise
log_f_h3 = abs(log10(sum(f_h(:,4,:,:),4)/10));
k_h3 = ceil(sum(k_h(:,4,:,:),4)/10);

% vanishing gradient noise
log_f_h4 = abs(log10(sum(f_h(:,5,:,:),4)/10));
k_h4 = ceil(sum(k_h(:,5,:,:),4)/10);


%% noll algorithm
f_n = zeros(15,2,5,5,10);
t_n = zeros(15,2,5,5,10);
k_n = zeros(15,2,5,5,10);
...
% no noise
log_f_n10 = abs(log10(f_n(:,1,:,1)));
k_n10 = k_n(:,1,:,1);
log_f_n40 = abs(log10(f_n(:,4,:,1)));
k_n40 = k_n(:,4,:,1);

% constant noise
log_f_n11 = abs(log10(sum(f_n(:,1,2,:,:),5)/10));
k_n11 = ceil(sum(k_n(:,1,2,:,:),5)/10);
log_f_n41 = abs(log10(sum(f_n(:,4,2,:,:),5)/10));
k_n41 = ceil(sum(k_n(:,4,2,:,:),5)/10);

% vanishing noise
log_f_n12 = abs(log10(sum(f_n(:,1,3,:,:),5)/10));
k_n12 = ceil(sum(k_n(:,1,3,:,:),5)/10);
log_f_n42 = abs(log10(sum(f_n(:,4,3,:,:),5)/10));
k_n42 = ceil(sum(k_n(:,4,3,:,:),5)/10);

% constant gradient noise
log_f_n13 = abs(log10(sum(f_n(:,1,4,:,:),5)/10));
k_n13 = ceil(sum(k_n(:,1,4,:,:),5)/10);
log_f_n43 = abs(log10(sum(f_n(:,4,4,:,:),5)/10));
k_n43 = ceil(sum(k_n(:,4,4,:,:),5)/10);

% vanishing gradient noise
log_f_n14 = abs(log10(sum(f_n(:,1,5,:,:),5)/10));
k_n14 = ceil(sum(k_n(:,1,5,:,:),5)/10);
log_f_n44 = abs(log10(sum(f_n(:,4,5,:,:),5)/10));
k_n44 = ceil(sum(k_n(:,4,5,:,:),5)/10);
