...
for i = 1:5
    ...
    stem(x+(i-1)*.15,log_f_n40(1:5,i), 'p:c','filled')
end
%Add a legend
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,k_n40(1:5,i), 'p:c','filled')
end
legend('Bundle Nonconv Inex', 'Variable Metric BFGS', ...
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,log_f_n41(1:5,i), 'p:c','filled')
end
%Add a legend
legend('Bundle Nonconv Inex', 'Variable Metric BFGS', ...
    'Variable Metric BFGS Adaptive')
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,k_n41(1:5,i), 'p:c','filled')
end
%Add a legend
legend('Bundle Nonconv Inex', 'Variable Metric BFGS', ...
    'Variable Metric BFGS Adaptive','Location','northwest')
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,log_f_n42(1:5,i), 'p:c','filled')
end
%Add a legend
legend('Bundle Nonconv Inex', 'Variable Metric BFGS', ...
    'Variable Metric BFGS Adaptive')
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,k_n42(1:5,i), 'p:c','filled')
end
%Add a legend
legend('Bundle Nonconv Inex', 'Variable Metric BFGS', ...
    'Variable Metric BFGS Adaptive','Location','northwest')
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,log_f_n43(1:5,i), 'p:c','filled')
end
% Add a legend
legend('Bundle Nonconv Inex', 'Variable Metric BFGS', ...
    'Variable Metric BFGS Adaptive')
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,k_n43(1:5,i), 'p:c','filled')
end
% Add a legend
legend('Bundle Nonconv Inex', 'Variable Metric BFGS', ...
    'Variable Metric BFGS Adaptive','Location','northwest')
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,log_f_n44(1:5,i), 'p:c','filled')
end
% Add a legend
legend('Bundle Nonconv Inex', 'Variable Metric BFGS', ...
    'Variable Metric BFGS Adaptive')
...
for i = 1:5
    ...
    stem(x+(i-1)*.15,k_n44(1:5,i), 'p:c','filled')
end
% Add a legend
legend('Bundle Nonconv Inex', 'Variable Metric BFGS', ...
    'Variable Metric BFGS Adaptive','Location','northwest')
