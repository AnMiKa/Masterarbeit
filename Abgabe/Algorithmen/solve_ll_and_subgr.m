...
% solves the lower level problem of the bilevel program and calculates the
% subgradient of the upper level problem using the adjoint problem given in
% Outrata, Kocvara, Zowe: "Nonsmooth Approacht to Optimization Problems with
% Equilibrium Constraints"

%% General
% tolerance lower level
tolll = 1e-15;
% tolerance adjoint problem
tolad = 1e-15;
